...
//        );
      ...
      print('inside printlist cat endloop');
      //catslist.removeAt(0);
      print('list=====');
  ...
  void initState() {
   ...
   // contCatid.text = widget.cat_max.toString();
  }
            ...
            */
            ...
            Positioned(
              ...
              child: IconButton(
                ...
                onPressed: () {
                  print('inside button');
                  Navigator.popAndPushNamed(context, "/ProductsMain");
...
///////
  ...
  addimagedata() {
    FirebaseFirestore.instance.collection("Category").doc().setData({
