...
import './CatrgoryTypeDetails.dart';
//import 'productdetails.dart';
//import 'package:cloudfirestore/cloudfirestore.dart';

class CategoryType extends StatefulWidget {
  @override
  CategoryTypeState createState() => CategoryTypeState();
}
QuerySnapshot cars;
class CategoryTypeState extends State<CategoryType> {
  void initState() {
    //  print("inside init");
  ...
  ///
  getData() async {
    //return await Firestore.instance.collection("Gym-CategoryType").snapshots();
        ...
        catslist.add(
            {
              ...
              "cat_id": cars.docs[i].data()['cat_id'].toString(),
              ...
              "cat_doc_id": cars.documents[i].documentID,
        ...
        child: InkWell(onTap: (){
          ...
          Navigator.of(context).push(
            new MaterialPageRoute(
                builder:  (BuildContext context) => new CategoryTypeDetails(
          ...
          child: GridTile(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Padding(
                        ...
                        child: new Text(cat_name,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16.0),),
                      ),
                    ),
                    Padding(
            ...
            child: Image.network(cat_img,fit: BoxFit.cover,),
          ),
        ),
      ),
      ),
